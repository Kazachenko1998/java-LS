...
//        destFolder = new File("testlnn\\тема");
//        ok = file.renameTo(new File(destFolder, file.getName()));
    }
...
//    testIn\тема                                                      111 1490861167273L 4096
...
//    }
    ...
    void lhof() throws IOException {
        assertFileContent("-l -h -o outPut testIn\\Ace_Stream_Media_3.1.2.exe".split(" "), "Ace_Stream_Media_3.1.2.exe xrw   последнее изменение 18.03.2016 05:33:05   75MB\n");
    ...
    void l_od() throws IOException {
        assertFileContent("-l -o outPut testIn".split(" "), "testIn\\Ace_Stream_Media_3.1.2.exe                                111 1458311585083 79522432\n" +
                ...
                "testIn\\тема                                                      111 1490861167273 0\n");
    }

    @Test
    @Tag("lh-d")
    void lhod() throws IOException {
        assertFileContent("-l -h -o outPut testIn".split(" "), "Ace_Stream_Media_3.1.2.exe                                xrw   последнее изменение 18.03.2016 05:33:05   75MB\n" +
                ...
                "TeamViewerPortable                                        xrw   последнее изменение 30.03.2017 11:05:24   (Папка) 0Byte\n" +
                ...
                "тема                                                      xrw   последнее изменение 30.03.2017 11:06:07   (Папка) 0Byte\n");
    }
...
//    }
    ...
    void __odr() throws IOException {
        assertFileContent("-r -o outPut testIn".split(" "), "тема\n" +
                "Tor Browser\n" +
                "teeworlds-0.5.1-win32\n" +
                "TeamViewerPortable\n" +
                "online-consultant.exe\n" +
    ...
    void lhofr() throws IOException {
        assertFileContent("-l -h -r -o outPut testIn\\Ace_Stream_Media_3.1.2.exe".split(" "), "Ace_Stream_Media_3.1.2.exe xrw   последнее изменение 18.03.2016 05:33:05   75MB\n");
    ...
    void l_odr() throws IOException {
        assertFileContent("-l -r -o outPut testIn".split(" "), "testIn\\тема                                                      111 1490861167273 0\n" +
                "testIn\\Tor Browser                                               111 1490861151914 0\n" +
                "testIn\\teeworlds-0.5.1-win32                                     111 1490861124716 0\n" +
                "testIn\\TeamViewerPortable                                        111 1490861124666 0\n" +
                "testIn\\online-consultant.exe                                     111 1450679908864 15745976\n" +
    ...
    void lhodr() throws IOException {
        assertFileContent("-l -h -r -o outPut testIn".split(" "), "тема                                                      xrw   последнее изменение 30.03.2017 11:06:07   (Папка) 0Byte\n" +
                "Tor Browser                                               xrw   последнее изменение 30.03.2017 11:05:51   (Папка) 0Byte\n" +
                "teeworlds-0.5.1-win32                                     xrw   последнее изменение 30.03.2017 11:05:24   (Папка) 0Byte\n" +
                "TeamViewerPortable                                        xrw   последнее изменение 30.03.2017 11:05:24   (Папка) 0Byte\n" +
                "online-consultant.exe                                     xrw   последнее изменение 21.12.2015 09:38:28   15MB\n" +
